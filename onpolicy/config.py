...
def get_config():
    ...
    # save parameters
    parser.add_argument("--save_interval", type=int, default=2, help="time duration between contiunous twice models saving.")
    ...
    parser.add_argument("--not_update", default=False, help="")


    parser.add_argument('--state_key', type=list, default=['current_phase', 'car_num', 'queue_length', "occupancy", 'flow', 'stop_car_num', 'pressure'])
    parser.add_argument("--port_start", type=int, default=-1, help="")
    parser.add_argument("--sumocfg_files", type=str, default="", help="")
    
    parser.add_argument("--cotrain", type=bool, default=False, help="")
    parser.add_argument("--model_interval", type=int, default=False, help="")
